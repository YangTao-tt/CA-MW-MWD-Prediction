...
def bayesian_optimize(n_estimators,  random_state):
    clf = ExtraTreesRegressor(n_estimators=int(n_estimators),
...
clf_best = ExtraTreesRegressor(n_estimators=int(best_params['n_estimators']),
...
# import joblib
# joblib.dump(clf_best, './ETR_MWD.pkl')
#
#
...
# plt.savefig('MWD_ETR.svg',dpi=600, bbox_inches = "tight")
plt.show()
