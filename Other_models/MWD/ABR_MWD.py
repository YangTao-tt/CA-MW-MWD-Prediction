...
def bayesian_optimize(n_estimators, learning_rate, random_state):
    clf = AdaBoostRegressor(n_estimators=int(n_estimators),
                           learning_rate=learning_rate,
                           random_state=int(random_state))
    kf = KFold(n_splits=10, shuffle=True, random_state=int(random_state))
...
clf_best = AdaBoostRegressor(n_estimators=int(best_params['n_estimators']),
...
# import joblib
# joblib.dump(clf_best, './ABR_MWD.pkl')
#
#
...
# plt.savefig('MWD_ABR.svg',dpi=600, bbox_inches = "tight")
plt.show()
