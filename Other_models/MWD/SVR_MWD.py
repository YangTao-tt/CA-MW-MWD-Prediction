...
def bayesian_optimize(gamma, epsilon,random_state):
    clf = SVR(gamma=float(gamma),
...
clf_best = SVR(gamma=float(best_params['gamma']),
...
# import joblib
# joblib.dump(clf_best, './SVR_MWD.pkl')
...
# plt.savefig('MWD_SVR.svg',dpi=600, bbox_inches = "tight")
plt.show()
